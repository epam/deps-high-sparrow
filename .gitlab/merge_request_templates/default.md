JIRA task: https://jiraeu/browse/<jira-task-id>
...
- [ ] Merge Request title fits user story title in Jira
- [ ] Merge Request changes fit definition of done
- [ ] My submission is covered by unit tests and they fit acceptance criteria
